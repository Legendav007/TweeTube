  ...
  return (
    <section className="w-full pb-[70px] sm:ml-[70px]  sm:pb-0 lg:ml-0">
      <ul className="flex flex-col gap-4 p-4  ">
                  ...
                  <div className="flex gap-x-2 md:w-7/12">
                    ...
                    <div className="w-full">
                      ...
                      <p className="mt-2 hidden text-sm md:block">
                        {video?.description && video.description.substr(0, 170) +
                        (video?.description && video.description.length > 170 ? "..." : "")}
                      </p>
                    </div>
                  </div>
                </div>
        ...
        {fetching && (
          <>
            <li key="loading" className="mt-2 flex items-center justify-center text-xl">
              {icons.loading}
              Please wait...
            </li>
          </>
